      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="principals-header-grid" width="40" height="40" patternUnits="userSpaceOnUse">
                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#ffffff" strokeWidth="0.5"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#principals-header-grid)" />
          </svg>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            Meet the experienced professionals guiding our clients to financial success
          </motion.p>
        </div>
      </motion.div>
      
      <JohnGarfieldBioSection />
      <CTASection />
    </div>
  );
}